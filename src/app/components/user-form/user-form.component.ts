    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      ...
      <form [formGroup]="userForm" (ngSubmit)="onSubmit()" class="space-y-4">
        ...
        <div class="space-y-2">
          ...
          />
          <div
            *ngIf="userForm.get('phone')?.errors?.['required'] && userForm.get('phone')?.touched"
            class="text-red-500 text-sm"
          >
            Phone is required
          </div>
          <div
            *ngIf="userForm.get('phone')?.errors?.['pattern'] && userForm.get('phone')?.touched"
            class="text-red-500 text-sm"
          >
        ...
        <div class="space-y-2">
          <label for="idNumber" class="text-sm font-medium text-gray-700"
            >ID Number</label
          >
          <input
            type="text"
          ...
          />
          <div
            *ngIf="userForm.get('idNumber')?.errors?.['required'] && userForm.get('idNumber')?.touched"
            class="text-red-500 text-sm"
          >
        ...
        <div class="space-y-2">
          <label for="picture" class="text-sm font-medium text-gray-700"
            >Picture</label
          >
          <input
            type="file"
          ...
          />
          <div
            *ngIf="!isValidFile && userForm.get('picture')?.touched"
            class="text-red-500 text-sm"
          >
...
export class UserFormComponent implements OnInit {
  ...
  // on edit mode, update the form fields when userData changes
  ...
  // Reset form fields and file validation
  resetForm() {
    this.userForm.reset(); // Clears all fields
    this.isValidFile = false; // Resets file validation
    this.userData = null;
  }
